...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { birthdate: @actor.birthdate, birthplace: @actor.birthplace, horoscope: @actor.horoscope, name: @actor.name, votes: @actor.votes } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { birthdate: @actor.birthdate, birthplace: @actor.birthplace, horoscope: @actor.horoscope, name: @actor.name, votes: @actor.votes } }
